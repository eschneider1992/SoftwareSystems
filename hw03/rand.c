...
// Double bit representation found here: http://en.wikipedia.org/wiki/Double-precision_floating-point_format
// More information on float vs. double bits http://en.wikipedia.org/wiki/Floating_point
